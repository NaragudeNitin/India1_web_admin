                  ...
                  children: [
                    const Row(
                      children: [
                        HeadingText(
                            headingText:
                                '${AppStrings.loanType} / ${AppStrings.appliedOn}'),
                        HeadingText(
                            headingText:
                                '${AppStrings.loanType} / ${AppStrings.appliedOn}'),
                        HeadingText(
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount: 9,
                        itemBuilder: (context, index) => const LoanInfoListTile(
                            loanType: 'Personal Loan',
                            appliedOn: '01 Nov 2022',
                            loanStatus: 'Approved',
                            dateOfAction: '15 Nov 2022',
                            provider: 'Policy Haat',
                            lender: 'Bajaj Bank'),
                      ),
                    ),
                  ],
