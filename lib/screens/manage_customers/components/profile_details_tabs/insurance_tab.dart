                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        itemCount: 9,
                        itemBuilder: (context, index) => const InsuranceInfoListTile(type: 'Personal accidents', purchasedOn: '23 Dec 2022', status: 'Successful', provider: 'Paid', premiumAmt: 'Rs 26,428', renewalPeriod: '1 year', statusPaidUnpaid: 'Paid',),),
                    ),
                  ],
                ),
              ),
...
class InsuranceInfoListTile extends StatelessWidget {
  const InsuranceInfoListTile({
    super.key, this.loanStatusColor, required this.type, required this.purchasedOn, required this.status, this.statusPaidUnpaid, required this.provider, required this.premiumAmt, required this.renewalPeriod,
  });
        ...
        Row(
          children: [
            ...
            Expanded(
              flex: 1,
              child: 
                  Text(premiumAmt,style: const TextStyle(
                    fontSize: 14,
                    color: AppColors.primaryTextColor,
                    fontWeight: FontWeight.w500,
            ...
            Expanded(
              flex: 1,
              child: 
                  Text(renewalPeriod,style: const TextStyle(
                    fontSize: 14,
                    color: AppColors.primaryTextColor,
                    fontWeight: FontWeight.w500,
